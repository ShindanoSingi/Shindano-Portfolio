     ...
     return (
          <div className={
               ...
               <div class="flex justify-center mt-[5rem]   mb-4">
                    <div class="block p-2 md:px-4 rounded-lg xl:text-2xl xl:p-8 text-xs md:text-[5rem] shadow-lg bg-white w-[92vw]">
                         <h5 class="text-gray-900 w-[92vw] leading-tight text-center mb-2 xl:text-[2rem]">ABOUT</h5>
                         I am a
