               ...
               <Box component="nav">
                    <AppBar position="fixed"
                         ...
                         <BottomNavigation className={
                              ...
                              <div className="invisible md:flex md:justify-around md:visible">
                                   <div className="bg-[tan] p-1 rounded-lg">My Apps</div>
                                   <div className="bg-[tan] p-1 rounded-lg">Skills</div>
                                   <div className="bg-[tan] p-1 rounded-lg">Contact Me</div>
                                   <div className="bg-[tan] p-1 rounded-lg">Resume</div>
                              </div>
                         </BottomNavigation>
