                    ...
                    <div class="flex justify-center pt-20">
                         <div class="flex flex-col font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
                              ...
                              <div class="p-4 flex flex-col font-sans font-light justify-start w-max-sm">
                                   ...
                                   <p class="text-gray-600 italic text-sm md:text-2xl font-sans font-light  text-center">Django | SQL | Templates | JavaScript | CSS | Materialize | Bootstrap | TailWindCSS</p>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
                              ...
                              <div class="p-4 flex flex-col md:text-xl justify-start w-max-sm">
                                   ...
                                   <li class="text-gray-700 font-sans font-light  text-sm md:text-2xl mb-4">
                                   ...
                                   <li class="text-gray-700 text-sm md:text-2xl font-sans font-light  mb-4">
                                   ...
                                   <li class="text-gray-700 text-sm font-sans font-light md:text-2xl mb-4">
                                   ...
                                   <p class="text-gray-600 text-sm md:text-2xl font-sans font-light  italic text-center">React | CSS | YouTube APIs | Vanilla JavaScript | Materials UI | Bootstrap
                                   </p>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col md:text-xl font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
                              ...
                              <div class="p-4 flex flex-col justify-start w-max-sm">
                                   ...
                                   <li class="text-gray-700 font-sans font-light text-sm md:text-2xl  mb-4">Made RESTful API fetch calls to an Express, MongoDB, Node.js backend</li>
                                   ...
                                   <li class="text-gray-700 text-sm font-sans font-light  md:text-2xl  mb-4">Used Vanilla Java Script, handlebars, EJS, CSS, bootstrap, and awesome fonts for the front end.</li>
                                   <li class="text-gray-700 font-sans font-light text-sm md:text-2xl mb-4">Made RESTful API fetch calls to an Express, MongoDB, Node.js backend handling all Create, Read, Update and Delete (CRUD) operations, and tested all backend routes during development using Postman.</li>
                                   <li class="text-gray-700 font-sans font-light text-sm  md:text-2xl  mb-4">Used Mongoose to define schemas for MongoDB collections, and express for the database.</li>
                                   <li class="text-gray-700 font-sans font-light text-sm  md:text-2xl  mb-4">Implemented ES6 tagged template literals with styled-components along CSS3 to provide style and flex-box layout of the application.</li>
                                   <h6 class="text-gray-900 font-sans font-medium text-xl  md:text-2xl text-center mb-4">Technologies</h6>
                                   <p class="text-gray-600 text-sm font-sans font-light  md:text-2xl  italic text-center">Express | MongoDB | Node.js | Vanilla JavaScript | handlebars | EJS | CSS | bootstrap | awesome fonts</p>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
                              ...
                              <div class="p-4 flex flex-col md:text-xl  justify-start w-max-sm">
                                   ...
                                   <li class="text-gray-700 font-sans font-light text-sm md:text-2xl  mb-4">Created a worldwide weather app using weather API. The app utilized these technologies: React, CSS, materialize, and BootStrap.</li>
                                   <h6 class="text-gray-900 text-xl font-sans font-medium  md:text-2xl text-center  mb-4">Technologies</h6>
                                   <p class="text-gray-600 text-sm font-sans font-light  md:text-2xl italic text-center">React | CSS | materialize | BootStrap</p>
                              </div>
                         </div>
                    </div>
