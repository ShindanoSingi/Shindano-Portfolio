          ...
          <div className="grid  min-h-screen bg-[#dcd8d8] ">
               ...
               <div className=" pb-2 mx-auto">
                    <div class="mx-auto  mt-[8rem] mb-2">
                         <div class="block rounded-lg  shadow-lg bg-white w-[90vw] mx-auto  md:max-w-xl text-center">
                    ...
                    <div class="block rounded-lg shadow-lg bg-white w-[90vw] md:max-w-xl text-center">
                         <div class="py-3 text-left text-3xl text-yellow-900 font-sans font-light  px-6 border-b border-gray-300">
                              CSS
                         </div>
                         <div class="p-6 grid grid-cols-2 gridAutoRows:   md:grid-rows-none items-center  font-sans font-light">
                              <div className='flex flex-col items-center'>
                                   <img src={css3}
                                        className='w-16'
                                        alt=' '/>
