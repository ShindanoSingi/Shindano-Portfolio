               ...
               <div className="grid h-screen place-items-center bg-gray-500">
                    ...
                    <div class="flex justify-center  mt-[8rem] mb-2">
                         ...
                         <div class="block rounded-lg shadow-lg bg-white w-screen mx-auto  md:max-w-sm text-center">
                              ...
                              <div class="p-6 flex font-sans justify-center gap-4 font-light">
                                   <div className='flex flex-col items-center'>
                                        <img src='https://img.favpng.com/9/15/14/css3-cascading-style-sheets-logo-html-png-favpng-zNceG1C3PUpjKThDUF68AN96N.jpg' className=' md:w-16' alt=' '/>
                                        <p className="text-xs md:md:text-base">CCS3</p>
                                        <a href="https://iconscout.com/icons/css3" target="_blank">Css3 Icon</a>
                                   ...
                                   <div className='flex flex-col items-center'>
                                        <img src={bootstrap}
                                             className='w-12  md:w-16'
                                             alt=' '/>
                                        <p className="text-xs md:text-base">BOOTSTRAP</p>
                                   </div>
                                   <div className='flex flex-col items-center'>
                                        <img src={materialize}
                                             className='w-12 md:w-16'
                                             alt=' '/>
                                        <p className="text-xs md:md:text-base">MATERIALIZE</p>
                                   </div>
                                   <div className='flex flex-col items-center'>
                                        <img src={materialui}
                                             className='w-12  md:w-16'
                                             alt=' '/>
                                        <p className="text-xs md:text-base">MATERIAL UI</p>
                                   </div>
                              </div>
                         </div>
                    </div>
