                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
                              ...
                              <div className='flex items-center justify-center gap-4 mb-4'>
                                   <div className='p-1 mb-2 text-sm text-center bg-blue-400 border border-black rounded-lg hover:bg-amber-600'><a href="https://bembe-tube.netlify.app/" target="_blank" rel="noopener noreferrer">Live App</a></div>
                                   <div>
