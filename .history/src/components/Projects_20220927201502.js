               ...
               <div className="grid mt-[5rem] h-screen mx-2 place-items-center">
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col py-2 md:max-w-md rounded-lg bg-white shadow-lg">
                              ...
                              <div class="p-4 flex flex-col justify-start w-max-sm">
                                   <h5 class="text-gray-900 text-xl text-center font-medium mb-4 capitalize">Real-Time Chat App</h5>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col py-2 md:max-w-md rounded-lg bg-white shadow-lg">
                              ...
                              <div class="p-4 flex flex-col justify-start w-max-sm">
                                   <a href="https://bembe-tube.netlify.app/">
                                        <h5 class="text-gray-900 text-xl text-center font-medium mb-4 hover:text-blue-600 underline capitalize">Ads-Free-YouTube-Clone</h5>
                                   </a>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex py-2  flex-col md:max-w-md rounded-lg bg-white shadow-lg">
                              <img class=" w-[22rem] mx-auto  h-full md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg"
                                   ...
                                   alt=""/>
                              <div class="p-4 flex flex-col justify-start w-max-sm">
                                   <h5 class="text-gray-900 text-xl text-center font-medium mb-4 capitalize">User Management System</h5>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex py-2  flex-col md:max-w-md rounded-lg bg-white shadow-lg">
                              ...
                              <div class="p-4 flex flex-col justify-start w-max-sm">
                                   <a href="https://bembe-weather.netlify.app/">
                                        <h5 class="text-gray-900 text-xl text-center font-medium mb-4 hover:text-blue-600 underline capitalize">Weather App</h5>
                                   </a>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex py-2  flex-col md:max-w-md rounded-lg bg-white shadow-lg">
                              ...
                              <div class="p-4 flex flex-col justify-start w-max-sm">
                                   <a href="https://shindanosingi.github.io/bembe-trivia/">
                                        <h5 class="text-gray-900 text-xl text-center font-medium mb-4 hover:text-blue-600 underline capitalize">Trivia</h5>
                                   </a>
