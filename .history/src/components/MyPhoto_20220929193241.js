          ...
          <div className='grid h-screen font-sans font-light bg-black place-items-center'>
               ...
               <div className="">
                    <img src={avatar}
                         ...
                         alt="Shindano Singi"/>
                    <div className="flex-col items-center justify-center py-2 mx-2 rounded-md lg:flex lg:justify-items-center lg:mx-auto lg:w-1/2 md:mx-4 md:py-4 bg-slate-600">
