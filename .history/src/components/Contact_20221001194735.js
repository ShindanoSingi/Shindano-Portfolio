     ...
     return (
          <div className="grid place-content-center  min-h-screen bg-[#050505] pb-4">
               ...
               <div className="flex flex-col gap-4 mt-[8rem] md:flex md:flex-row">
                    ...
                    <div className=" p-4 rounded-lg grid grid-cols-2 items-center grid-flow-row-dense px-auto  gap-4 shadow-lg bg-stone-700 max-w-sm h-[1/2] mx-2 md:justify-evenly md:flex md:flex-col md:items-center">
