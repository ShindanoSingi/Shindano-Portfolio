          ...
          <div className="grid min-h-full place-items-center bg-[#dcd8d8]">
               ...
               <div className="flex flex-col min-h-full  px-2 font-sans font-light py-2  gap-4 pt-[4rem]  bg-black  min-w-full">
                    <div class="flex justify-center pt-20">
                         ...
                         <div className='p-1 text-xs text-center bg-blue-400 border border-black rounded-lg'>Live</div>
                                   <div>
                                   <img class=" w-[22rem] mx-auto h-full md:w-48  object-cover rounded-t-lg md:rounded-none md:rounded-l-lg"
                                   src={chatApp}
                                   alt=""/>
                                   </div>
                                   <div className='p-1 text-xs text-center bg-blue-400 border border-black rounded-lg hover:bg-amber-600'><a href="https://github.com/ShindanoSingi/BembeChat" target="_blank" rel="noopener noreferrer">GitHub</a> </div>
                              </div>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
                              ...
                              <div className='flex items-center justify-center gap-4 mb-4'>
                                   <div className='p-1 mb-2 text-xs text-center bg-blue-400 border border-black rounded-lg md:text-xl hover:bg-amber-600'><a href="https://bembe-tube.netlify.app/" target="_blank" rel="noopener noreferrer">Live</a></div>
                                   <div>
                                   <img class=" w-[22rem] mx-auto h-full md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg"
                                        src={youtube}
                                        alt=""/>
                                   </div>
                                   <div className='p-1 text-xs text-center bg-blue-400 border border-black rounded-lg hover:bg-amber-600'><a href="https://github.com/ShindanoSingi/bembe-tube" target="_blank" rel="noopener noreferrer">GitHub</a> </div>
                              </div>

                                   <a href="https://bembe-tube.netlify.app/" target="_blank" rel="noopener noreferrer">
                                        <h5 class="text-gray-900 text-lg text-center font-sans font-medium mb-4 md:text-xl   uppercase">Ads-Free-YouTube Clone</h5>
                                   </a>
                    ...
                    <div class="flex justify-center mb-4">
                         ...
                         <div className='p-1 text-xs text-center bg-blue-400 border border-black rounded-lg'>Live</div>
                                   ...
                                   <div className='p-1 text-xs text-center bg-blue-400 border border-black rounded-lg hover:bg-amber-600'><a href="https://github.com/ShindanoSingi/poor-man-twitter" target="_blank" rel="noopener noreferrer">GitHub</a> </div>
                              </div>

                              <div class="p-4 flex flex-col justify-start w-max-sm">
                                   <h5 class="text-gray-900 text-xl text-center md:text-2xl font-sans font-medium mb-4 uppercase">Poor Man's Twitter</h5>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col md:text-lg font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
                              ...
                              <div className='p-1 text-xs text-center bg-blue-400 border border-black rounded-lg'>Live</div>
                                   ...
                                   <div className='p-1 text-xs text-center bg-blue-400 border border-black rounded-lg hover:bg-amber-600'><a href="https://github.com/ShindanoSingi/Songs-Library" target="_blank" rel="noopener noreferrer">GitHub</a> </div>
                              </div>

                              <div class="p-4 flex flex-col justify-start w-max-sm">
                                   <h5 class="text-gray-900 text-2xl text-center font-sans font-medium mb-4 uppercase">User Management System</h5>
                                   <li class="text-gray-700 font-sans font-light text-xl md:text-lg  mb-4">Made RESTful API fetch calls to an Express, MongoDB, Node.js backend</li>
                                   ...
                                   <li class="text-gray-700 text-xl font-sans font-light  md:text-lg  mb-4">Used Vanilla Java Script, handlebars, EJS, CSS, bootstrap, and awesome fonts for the front end.</li>
                    ...
                    <div class="flex justify-center mb-4">
                         ...
                         <div className='flex items-center justify-center gap-4'>
                         <div className='p-1 text-xs text-center bg-blue-400 border border-black rounded-lg hover:bg-amber-600'><a href="https://bembe-weather.netlify.app/" target="_blank" rel="noopener noreferrer">Live</a> </div>
                                   <div>
                                   <img class=" w-[22rem] mx-auto  h-full md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg"
                                        src={weather}
                                        alt=""/>
                                   </div>
                                   <div className='p-1 text-xs text-center bg-blue-400 border border-black rounded-lg hover:bg-amber-600'><a href="https://github.com/ShindanoSingi/bembe-weather" target="_blank" rel="noopener noreferrer">GitHub</a> </div>
                              </div>

                              <div class="p-4 flex flex-col md:text-lg  justify-start w-max-sm">
                                   <a href="https://bembe-weather.netlify.app/" target="_blank" rel="noopener noreferrer">
                                        <h5 class="text-gray-900 text-lg text-center font-sans font-medium mb-4 md:text-xl uppercase">Weather App</h5>
                                   </a>
                                   <li class="text-gray-700 font-sans font-light text-xl md:text-lg  mb-4">Created a worldwide weather app using weather API. The app utilized these technologies: React, CSS, materialize, and BootStrap.</li>
                                   <h6 class="text-gray-900 text-xl font-medium font-sans text-center  mb-4">Technologies</h6>
                                   <p class="text-gray-600 text-xl font-sans font-light  md:text-lg italic text-center">React | CSS | materialize | BootStrap</p>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="flex justify-center mb-4">
                         ...
                         <div className='p-1 text-xs text-center bg-blue-400 border border-black rounded-lg'>Live</div>
                                   ...
                                   <div className='p-1 text-xs text-center bg-blue-400 border border-black rounded-lg hover:bg-amber-600'><a href="https://github.com/ShindanoSingi/bembe-trivia" target="_blank" rel="noopener noreferrer">GitHub</a> </div>
                              </div>
                              <div class="p-4 flex flex-col md:text-lg justify-start w-max-sm">
                                   <a href="https://shindanosingi.github.io/bembe-trivia/" target="_blank" rel="noopener noreferrer">
                                        <h5 class="text-gray-900 text-lg text-center font-sans font-medium  mb-4 md:text-xl uppercase">Trivia</h5>
                                   </a>
