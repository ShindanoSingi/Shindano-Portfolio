          ...
          <div className={
               ...
               <div className="grid h-screen place-items-center">
                    <div class="flex justify-center  mt-[5rem] mb-4 bg-opacity-0">
                         <div className="text-center fixed top-[4rem] h-16 min-w-full justify-center  text-4xl  bg-teal-600">
                              <h5 class="text-gray-900 w-[92vw] leading-tight font-sans font-light  text-center mb-2">ABOUT</h5>
                         </div>
