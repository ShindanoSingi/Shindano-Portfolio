...
const Projects = () => {
     return (
          <div className="grid min-h-full place-items-center">
               <div className="flex flex-col min-h-full px-2 font-sans font-light  gap-4 pt-[5rem] bg-white">
                    <div class="flex justify-center">
                         <div class="flex flex-col font-sans font-light p-2 md:max-w-md rounded-lg bg-white shadow-lg">
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex font-sans font-light  flex-col p-2 md:max-w-md rounded-lg bg-white shadow-lg">
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex p-2 font-sans font-light  flex-col md:max-w-md rounded-lg bg-white shadow-lg">
                              <img class=" w-[22rem] mx-auto  h-full md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg"
                                   src={userM}
                                   alt=""/>
                              <div class="p-4 flex flex-col justify-start w-max-sm">
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex p-2  flex-col font-sans font-light  md:max-w-md rounded-lg bg-white shadow-lg">
                    ...
                    <div className="grid mt-[5rem] h-screen bg-white  mx-2 place-items-center">
                         <div class="flex justify-center mb-4">
                              <div class="flex flex-col font-sans font-light p-2 md:max-w-md rounded-lg bg-white shadow-lg">
                                   <img class=" w-[22rem] mx-auto h-full md:w-[15rem]  object-cover rounded-t-lg md:rounded-none md:rounded-l-lg"
                                        src={chatApp}
                                   ...
                                   <div class="p-4 flex flex-col justify-start w-max-sm">
                                        ...
                                        <h6 class="text-gray-900 text-xl text-center font-medium mb-4">Technologies</h6>
                                        <p class="text-gray-600 sm:text-lg italic text-center">Django | SQL | Templates | JavaScript | CSS | Materialize | Bootstrap | TailWindCSS</p>
                                   </div>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex py-2 font-sans font-light  flex-col md:max-w-md rounded-lg bg-white shadow-lg">
                              <a href="https://bembe-weather.netlify.app/">
                                   <img class=" w-[22rem] mx-auto  h-full md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg"
                                        src={weather}
                                        alt=""/>
