               ...
               <div className="grid h-screen mx-1 place-items-center">
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg">
                              ...
                              <div class="p-2 flex flex-col justify-start w-max-sm">
                                   <a href="https://bembe-tube.netlify.app/">
                                        <h5 class="text-gray-900 text-xl text-center font-medium mb-4 hover:text-blue-600">Ads-Free-YouTube-Clone</h5>
                                   </a>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg">
                              ...
                              <div class="p-2 flex flex-col justify-start w-max-sm">
                                   <a href="https://bembe-weather.netlify.app/">
                                        <h5 class="text-gray-900 text-xl text-center font-medium mb-4 hover:text-blue-600">Weather App</h5>
                                   </a>
