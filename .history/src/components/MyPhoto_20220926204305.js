          ...
          <div className='bg-zinc-900 h-[100vh] tablet:bg-red-200'>
               <div className="translate-y-1/2 md:relative md:translate-y-1/3">
                    <img src={avatar}
                         ...
                         alt="Shindano Singi"/>
                    <div className="py-1 mx-2 bg-slate-600 lg:bg-green-600 xl:bg-yellow-700 2xl:bg-cyan-300 bg-opacity-12">
                         <h2 className="mx-auto text-white text-2xl md:text-2xl lg:text-2xl w-[90vw] text-center 2xl:text-2xl ">I want to
