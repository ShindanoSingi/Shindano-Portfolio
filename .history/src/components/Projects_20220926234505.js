                    ...
                    <div class="flex justify-center">
                         <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg">
                              ...
                              <div class="p-2 flex flex-col justify-start w-max-sm">
                                   ...
                                   <h6 class="text-gray-900 text-xl text-center font-medium mb-2 text-center">Technologies</h6>
                                   <p class="text-gray-600 italic">Django | SQL | Templates | JavaScript | CSS | Materialize | Bootstrap | TailWindCSS</p>
                              </div>
                         </div>
                    </div>
               </div>
