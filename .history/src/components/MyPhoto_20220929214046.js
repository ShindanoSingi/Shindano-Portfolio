...
const MyPhoto = () => {
     ...
     return (
          <div className='grid h-screen font-sans font-light bg-black place-items-center'>
               ...
               <img src={avatar}
                    className="w-3/4 mx-auto h-3/4 lg:w-1/2 lg:mx-auto "
                    alt="Shindano Singi"/>
               <div className="flex flex-col items-center justify-center gap-6 py-2 mx-2 mb-[30rem] rounded-md md:mx-12 lg:w-max-lg md:py-4 bg-slate-600">
