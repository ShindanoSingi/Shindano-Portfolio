               ...
               <div className="grid h-screen mx-2 place-items-center">
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col md:max-w-2xl rounded-lg bg-white shadow-lg">
                              <img class=" w-max-sm mx-1  h-full md:h-auto object-cover md:w-max-md rounded-t-lg md:rounded-none md:rounded-l-lg"
                                   src={chatApp}
                                   alt=""/>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col py-2 md:max-w-xl rounded-lg bg-white shadow-lg">
                              <a href="https://bembe-tube.netlify.app/">
                                   <img class=" w-max-sm mx-2 h-full md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg"
                                        src={youtube}
                                        alt=""/>
                              </a>
