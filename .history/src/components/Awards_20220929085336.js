                         ...
                         <div class="block rounded-lg md:mb-2  shadow-lg bg-white w-[90vw] mx-auto  md:max-w-4xl text-center">
                              ...
                              <div class="p-6 flex font-sans justify-center gap-12 font-light">
                                   <div className='flex flex-col items-center'>
                                        <p className="text-lg text-orange-900 mb-2">Central Maine Community College | 2015</p>
                                        <li className="text-base">Awarded to student who had GPA from 3.8/4.0 to 4.0/4.0</li>
                                   </div>
                              </div>
                         </div>
                    </div>
