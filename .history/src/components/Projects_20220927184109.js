...
const Projects = () => {
     return (
          <div className="">
               <div className="grid h-screen mx-2 place-items-center">
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col py-2 md:max-w-xl rounded-lg bg-white shadow-lg">
                              <img class=" w-[10rem] mx-auto  h-[15rem] md:w-[15rem]  object-cover rounded-t-lg md:rounded-none md:rounded-l-lg"
                                   src={chatApp}
                                   alt=""/>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col py-2 md:max-w-xl rounded-lg bg-white shadow-lg">
                              <a href="https://bembe-tube.netlify.app/">
                                   <img class=" w-[10rem] mx-auto  h-[15rem] md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg"
                                        src={youtube}
                                        alt=""/>
                              </a>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex py-2  flex-col md:max-w-xl rounded-lg bg-white shadow-lg">
                              <img class=" w-max-sm mx-auto  h-full md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg"
                                   src={userM}
                                   alt=""/>
                              <div class="p-4 flex flex-col justify-start w-max-sm">
