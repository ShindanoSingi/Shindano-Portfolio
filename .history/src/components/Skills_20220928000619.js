               ...
               <div className="grid h-screen place-items-center">
                    <div class="flex justify-center  mt-[5rem] mb-2">
                         ...
                         <div class="block rounded-lg shadow-lg bg-white w-screen mx-auto  md:max-w-sm text-center">
                              ...
                              <div class="p-6 flex font-sans font-light">
                    ...
                    <div class="block rounded-lg shadow-lg bg-white w-full justify-evenly  md:max-w-sm text-center">
                         <div class="py-3 text-3xl text-yellow-900 font-sans font-light  px-6 border-b border-gray-300">
                              HTML
                         </div>
                         <div class="p-6 grid grid-cols-2 justify-around align-baseline font-sans font-light">
                              <div className='flex flex-col items-center'>
                                   <img src={html}
                                        className='w-16'
                                        alt=' '/>
