...
const Contact = () => {
     ...
     return (
          <div className="grid  min-h-screen bg-[#050505] pb-4">
               <div class="block p-6 rounded-lg shadow-lg bg-white max-w-sm h-fit mt-36 mx-2">
                    <form>
                         ...
                         <div class="form-group mb-6">
                              ...
                              <input type="password" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInputPassword1" placeholder="Password"/></div>
