...
const Projects = () => {
     return (
          <div className="grid py-2 min-h-full place-items-center">
               <div className="flex flex-col min-h-full px-2 font-sans font-light  gap-4 pt-[5rem] bg-stone-400  min-w-full">
                    <div class="flex justify-center">
                         <div class="flex flex-col font-sans font-light p-2 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
