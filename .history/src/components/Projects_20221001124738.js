...
const Projects = () => {
     return (
          <div className="grid min-h-full place-items-center bg-[#dcd8d8]">
               <div className="text-center fixed top-[3.5rem] md:top-[5rem] h-16 min-w-full  justify-center text-white py-2   bg-teal-800">
                    <h5 class=" align-baseline leading-tight font-sans font-light text-2xl  text-center">PROJECTS</h5>
               </div>
