...
const Contact = () => {
     ...
     const sendEmail = (e) => {
          ...
          emailjs.sendForm('service_e2eqm5a', 'service_e2eqm5a', form.current, 'pNVbpstluPDpZ6L20').then((result) => {
     ...
     return (
          <div className="grid place-content-center  min-h-screen bg-[#050505] pb-4">
               ...
               <div className="flex">
                         ...
                         <div className="flex justify-evenly">
                              <form ref={form}
                                   ...
                                   <div class="form-group mb-6">
                                        <label for="exampleInputEmail1" class="form-label inline-block mb-2 text-gray-700">Enter name</label>
                    ...
                    <div className=" p-6 rounded-lg shadow-lg bg-white max-w-sm h-fit flex flex-col mx-2">
