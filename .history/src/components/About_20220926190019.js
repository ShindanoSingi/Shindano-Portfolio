     ...
     return (
          <div className={
               ...
               <div class="flex justify-center mt-[5rem] mb-4">
                    <div class="block p-2 rounded-lg text-xs md:text-3xl shadow-lg bg-white w-[92vw]">
                         <h5 class="text-gray-900 w-[92vw] text-lg md:text-3xl leading-tight text-center font-medium mb-2">ABOUT</h5>
                         I am a
