     ...
     return (
          <div className="grid place-content-center  min-h-screen bg-[#050505] pb-4">
               ...
               <div className="flex flex-col ">
                    ...
                    <div className=" p-4 rounded-lg grid grid-cols-2 place-content-center gap-2 shadow-lg bg-stone-700 max-w-sm h-[1/2] mx-2 md:justify-evenly md:flex md:flex-col items-center">
