               ...
               <div className="flex">
                    ...
                    <div className=" p-6 rounded-lg shadow-lg bg-stone-700 h-[1/2] max-w-sm justify-evenly flex flex-col items-center">
                         <a href="mailTo:shindanosingi1@gmail.com">
                              <div className="flex bg-[tan] text-[#222] text-lg font-medium font-sans rounded-lg p-0.5 w-[7rem] h-12 py-3  px-2 items-center">
                                   <EmailIcon/>
                                   Email Me
                              </div>
                         </a>
                         ...
                         <a href={pdf}
                              ...
                              <div className="bg-[tan] text-[#222] hidden sm:block text-lg text-center font-medium font-sans w-[9rem]  h-12 py-3  p-0.5 rounded-lg">
