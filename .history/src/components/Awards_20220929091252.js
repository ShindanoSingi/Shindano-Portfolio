...
const Awards = () => {
     return(< className = "grid  min-h-screen bg-[#dcd8d8] " > <div className="text-center fixed top-[3.5rem]  md:top-[4rem] h-16 min-w-full py-auto  justify-center   bg-teal-600">
     ...
     <div className=" pb-2 mx-auto md:mt-4">
          ...
          <div className=" pb-2 mx-auto md:mt-4">
               ...
               <div class="block rounded-lg md:mb-2  shadow-lg bg-white w-[90vw] mx-auto  md:max-w-4xl text-center">
                    ...
                    <div class="p-6 flex font-sans justify-center gap-12 font-light">
                         <div className='flex flex-col items-center'>
                              <p className="text-lg text-yellow-900 mb-2">UNIV. OF SOUTHERN MAINE| 2015</p>
