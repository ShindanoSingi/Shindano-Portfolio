               ...
               <div className="flex flex-col min-h-full  px-2 font-sans font-light py-2  gap-4 pt-[4rem]  bg-black  min-w-full">
                    ...
                    <div class="flex justify-center mb-4">
                         ...
                         <div className='p-1 text-sm text-center bg-blue-400 border border-black rounded-lg'>Live App</div>
                                   ...
                                   <div className='p-1 text-sm text-center bg-blue-400 border border-black rounded-lg'><a href="https://github.com/ShindanoSingi/bembe-trivia" target="_blank" rel="noopener noreferrer">GitHub</a> </div>
                              </div>
                              <div class="p-4 flex flex-col md:text-lg justify-start w-max-sm">
