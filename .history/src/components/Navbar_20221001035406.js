                         ...
                         <Toolbar className='w-screen '>
                              <div className="flex items-center gap-4">
                                   ...
                                   <div className=" w-[90vw] flex justify-evenly">
                                        <Link to={'/projects'}>
                                             <div className="bg-[tan] text-[#222] hidden md:block   p-1 px-2 rounded-lg">My Apps</div>
                                        </Link>
                                        <Link to={'/skills'}>
                                        ...
                                        <a href={pdf}
                                             ...
                                             download='Download Resume'
                                             rel='noopener noreferrer'>
                                             <div className="bg-[tan] text-[#222] hidden md:block  p-1 rounded-lg">Download Resume</div>
                                        </a>
