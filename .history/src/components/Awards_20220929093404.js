...
const Awards = () => {
     return (
          <div className="grid  min-h-screen bg-[#dcd8d8] ">
                    ...
                    <div class="block rounded-lg mb-2 md:mb-2  shadow-lg bg-white w-[90vw] mx-auto  md:max-w-4xl text-center">
                         ...
                         <div class="p-6 flex font-sans justify-center gap-12 font-light">
                              <div className='flex flex-col items-center'>
                                   ...
                                   <li className="text-base">Presented my project "Micro ElectroMechanical Systems (MEMS) Piezo Electric Energy Harvester" at the University at Buffalo, NY.
                    ...
                    <div class="block rounded-lg md:mb-2  shadow-lg bg-white w-[90vw] mx-auto  md:max-w-4xl text-center">
                         ...
                         <div class="p-6 flex font-sans justify-center gap-12 font-light">
                              <div className='flex flex-col items-center'>
                                   ...
                                   <li className="text-base">My project "Micro ElectroMechanical Systems (MEMS) Piezo Electric Energy Harvester" received fund from UROP</li>
                              </div>
                         </div>
                    </div>
               </div>
               ...
               <div class="block rounded-lg md:mb-2  shadow-lg bg-white w-[90vw] mx-auto  md:max-w-4xl text-center">
                    <div class="py-3 text-center  text-2xl text-teal-700 font-sans font-light  px-6 border-b border-gray-300">
                         MAINE SPACE GRANT (MSG)
                    </div>
                    <div class="p-6 flex font-sans justify-center gap-12 font-light">
                         <div className='flex flex-col items-center'>
                              <p className="text-lg text-yellow-900 mb-2">UNIV. OF SOUTHERN MAINE| 2019</p>
                              <li className="text-base">My project "Micro ElectroMechanical Systems (MEMS) Piezo Electric Energy Harvester" was selected to received grant from the state of Maine Space Grant</li>
                         </div>
                    </div>
               </div>
          </div>
