...
const MyPhoto = () => {
     ...
     return (
          <div className='grid h-screen px-4 font-sans font-light lace-items-center'>

               <div className="">
                    <img src={avatar}
                         className="w-full h-full lg:w-1/2 lg:mx-auto "
                         alt="Shindano Singi"/>
                    <div className="max-w-2xl py-2 mx-2 rounded-md lg:mx-auto md:mx-4 md:py-4 bg-slate-600">
