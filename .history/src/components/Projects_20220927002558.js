               ...
               <div className="grid h-screen mx-1 place-items-center">
                    ...
                    <div class="flex justify-center mb-2">
                         <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg">
                              ...
                              <div class="p-2 flex flex-col justify-start w-max-sm">
                                   <a href="https://bembe-tube.netlify.app/">
                                        <h5 class="text-gray-900 text-xl text-center font-medium mb-2 hover:text-blue-600">Ads-Free-YouTube-Clone</h5>
                                   </a>
                    ...
                    <div class="flex justify-center mb-2">
                         <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg">
                              <img class=" w-max-sm mx-1  h-full md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg"
                                   ...
                                   alt=""/>
                              <div class="p-2 flex flex-col justify-start w-max-sm">
                                   <h5 class="text-gray-900 text-xl text-center font-medium mb-2">User Management System</h5>

                                   <li class="text-gray-700 text-base mb-4">Made RESTful API fetch calls to an Express, MongoDB, Node.js backend</li>
                                   <li>Created an application that utilized fetch calls to YouTube videos API. Implemented a user management system to let the user create an account so he/she could be able to sign in and access the YouTube app that I customized to play videos without ads.</li>
                                   <li>Used Vanilla Java Script, handlebars, EJS, CSS, bootstrap, and awesome fonts for the front end.</li>
                                   <li>Made RESTful API fetch calls to an Express, MongoDB, Node.js backend handling all Create, Read, Update and Delete (CRUD) operations, and tested all backend routes during development using Postman.</li>
                                   <li>Used Mongoose to define schemas for MongoDB collections, and express for the database.</li>
                                   <li></li>
                                   <h6 class="text-gray-900 text-xl text-center font-medium mb-2">Technologies</h6>
                                   <p class="text-gray-600 italic text-center">Django | SQL | Templates | JavaScript | CSS | Materialize | Bootstrap | TailWindCSS</p>
                              </div>
