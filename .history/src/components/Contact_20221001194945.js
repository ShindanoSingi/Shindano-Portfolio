...
const Contact = () => {
     ...
     return (
          <div className="grid place-content-center  min-h-screen bg-[#050505] pb-4">
               ...
               <div className="flex flex-col gap-4 mt-[8rem] md:flex md:flex-row">
                    <div class="block p-6 rounded-lg shadow-lg bg-white max-w-sm h-fit mx-2">
                         <div className="flex justify-evenly">
                              <form ref={form}
                                   ...
                                   <SendIcon type="submit" value="Send" class="px-6 py-2.5  bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Send</SendIcon>
                              </form>
                         </div>
                    </div>

                    <div className=" p-4 rounded-lg grid grid-cols-2 items-center px-auto  gap-4 shadow-lg bg-stone-700 max-w-sm h-[1/2] mx-2 md:justify-evenly md:flex md:flex-col md:items-center">
                         <a href="mailTo:shindanosingi1@gmail.com">
                              <div className="bg-[tan] text-[#222]  hover:bg-[tomato]  text-lg text-center font-medium font-sans w-[6.7rem]  md:w-[9rem]  h-12 py-3  px-0.5 rounded-lg">
                                   <EmailIcon/>
                                   Email Me
                              </div>
                         </a>
                         ...
                         <a href={pdf}
                              ...
                              <div className="bg-[tan] text-[#222] w-[6.7rem] hover:bg-[tomato]  text-lg text-center font-medium font-sans md:w-[9rem]  h-12 py-3  px-0.5 rounded-lg">
