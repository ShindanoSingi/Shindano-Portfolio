                         ...
                         <Toolbar className='w-screen '>
                              <div className="flex items-center gap-4">
                                   ...
                                   <div className=" w-[90vw] flex justify-evenly">
                                        <Link to={'/projects'}>
                                             <div className="bg-[tan] text-[#222] hidden   p-1 px-2 rounded-lg">My Apps</div>
                                        </Link>
                                        <Link to={'/skills'}>
                                             <div className="bg-[tan] text-[#222] px-2 hidden  p-1 rounded-lg">Skills</div>
                                        </Link>
                                        <Link to={'/contact'}>
                                             <div className="bg-[tan] text-[#222] px-2 hidden  p-1 rounded-lg">Contact Me</div>
                                        </Link>
