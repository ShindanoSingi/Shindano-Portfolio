...
const Education = () => {
     return (
          <div className="flex flex-col min-h-screen font-sans font-light  gap-4 py-[5rem]  bg-black">
               <div className="text-center fixed top-[2.5rem]  md:top-[4rem] h-16 min-w-full py-auto  justify-center text-white   bg-teal-800">
               ...
               <div class="flex mt-[5rem]  justify-center">
                    <div class="block w-[92vw] font-sans text-lg  rounded-sm shadow-lg bg-white max-w-4xl md:text-xl text-center">
                         <div class="py-3 px-3 flex justify-around  items-center  border-b border-gray-300">
                              ...
                              <a href="https://catalog.usm.maine.edu/preview_program.php?catoid=6&poid=1195" target="_blank" rel='noopener noreferrer'>
                                   <h1 className="px-3 hover:bg-[#01529B] hover:text-white w-fit mt-0.5">UNIV. OF SOUTEHRN MAINE</h1>
                              </a>
