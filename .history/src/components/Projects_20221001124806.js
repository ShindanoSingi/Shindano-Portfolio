...
const Projects = () => {
     return (
          <div className="grid min-h-full place-items-center bg-[#dcd8d8]">
               <div className="text-center fixed top-[3.5rem] md:top-[5rem] h-16 min-w-full  justify-center text-white   bg-teal-800">
                    <h5 class=" align-baseline my-2 leading-tight font-sans font-light text-2xl  text-center">PROJECTS</h5>
               </div>
