                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col md:text-lg font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
                              ...
                              <div class="p-4 flex flex-col justify-start w-max-sm">
                                   ...
                                   <li class="text-gray-700 font-sans font-light text-sm md:text-lg  mb-4">Created a single-page full-stack web application (poor man’s Twitter) using SQL for the backend, Vue, CSS, TailwindCSS, bootstrap, CSS, and Javascript for the front end.
</li>
                                   <li class="text-gray-700 text-sm font-sans font-light  md:text-lg  mb-4">Used Axios for API calls.</li>
