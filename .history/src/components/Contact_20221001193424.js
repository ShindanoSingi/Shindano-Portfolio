               ...
               <div className="flex flex-col ">
                    ...
                    <div className=" p-4 rounded-lg grid grid-cols-2 items-center  gap-2 shadow-lg bg-stone-700 max-w-sm h-[1/2] mx-2 md:justify-evenly md:flex md:flex-col md:items-center">
                         <a href="mailTo:shindanosingi1@gmail.com">
                              <div className="bg-[tan] text-[#222]  text-lg text-center font-medium font-sans w-[6.7rem]  md:w-[9rem]  h-12 py-3 rounded-lg">
                                   <EmailIcon/>
                                   Email Me
                              </div>
                         </a>
                         ...
                         <a href={pdf}
                              ...
                              <div className="bg-[tan] text-[#222] w-[6.7rem]  text-lg text-center font-medium font-sans md:w-[9rem]  h-12 py-3 rounded-lg">
