...
const About = () => {
     ...
     return (
          <div className={
               ...
               <div className="grid h-screen place-items-start">
                    <div class="flex justify-center  mt-[5rem] mb-4">
                         ...
                         <div class="block p-2 md:p-4 font-sans  rounded-lg xl:text-3xl xl:p-8 font-light  md:text-xl shadow-lg bg-white w-[92vw]">
