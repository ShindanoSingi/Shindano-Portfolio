                         ...
                         <Toolbar className='w-screen '>
                              <div className="flex items-center gap-4">
                                   ...
                                   <div className=" w-[90vw] flex justify-evenly">
                                        ...
                                        <Link to={'/skills'}>
                                             <div className="bg-[tan] text-[#222] px-2 invisible  p-1 rounded-lg">Skills</div>
                                        </Link>
                                        <Link to={'/contact'}>
                                        ...
                                        <a href={pdf}
                                             ...
                                             download='Download Resume'
                                             rel='noopener noreferrer'>
                                             <div className="bg-[tan] text-[#222] invisible md:block  p-1 rounded-lg">Download Resume</div>
                                        </a>
