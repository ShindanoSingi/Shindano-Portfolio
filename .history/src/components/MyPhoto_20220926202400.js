...
const MyPhoto = () => { // const classes = useStyles();
     return (
          <div className='bg-zinc-900 h-[100vh] tablet:bg-red-200'>
               <div className="translate-y-1/2 md:relative md:top-0">
                    <img src={avatar}
                         className="w-full h-full  lg:w-[30rem] "
                         alt="Shindano Singi"/>
                    <div className="py-1 mx-1 bg-slate-600 md:bg-red-400 lg:bg-green-600 xl:bg-yellow-700 2xl:bg-cyan-300 bg-opacity-12">
                         <h2 className="mx-auto text-white text-sm md:text-xl lg:text-2xl w-[90vw] text-center 2xl:text-2xl ">I want to
