     ...
     return (
          <div>
               <div className="grid h-screen place-items-center">
                    <div class="flex justify-center  mt-[5rem] mb-2">
                         ...
                         <div class="block rounded-lg shadow-lg bg-white w-screen mx-auto  md:max-w-sm text-center">
                              ...
                              <div class="p-6 flex font-sans justify-center font-light">
                                   <div className='flex flex-col items-center'>
                                        <img src={html}
                                             className='w-16'
                                             alt=' '/>
                                        <p className="md:md:text-base">HTML5</p>
                                   </div>
                                   <div className='flex flex-col items-center'>
                                        <img src={react}
                                             className='w-16'
                                             alt=' '/>
                                        <p className="md:text-base">JSX</p>
                                   </div>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="block rounded-lg shadow-lg bg-white w-full  md:max-w-sm text-center">
                         ...
                         <div class="p-6 flex items-baseline gap-2 justify-evenly  font-sans font-light">
                              <div className='flex flex-col items-center'>
                                   <img src={html}
                                        className='w-16'
                                        alt=' '/>
                              ...
                              <div className='flex flex-col items-center'>
                                   <img src={materialui}
                                        className='w-16'
                                        alt=' '/>
                                   <p className="md:text-base">MATERIAL UI</p>
                              </div>
                         </div>
                    </div>
               </div>
