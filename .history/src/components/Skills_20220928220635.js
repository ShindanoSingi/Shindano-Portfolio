...
const Skills = () => {
     return (
          <div className="min-h-[100%]">
               <div className="grid min-h-screen place-items-center bg-[#dcd8d8] pb-2">
                    <div className="text-center fixed top-[3.5rem]  md:top-[4rem]h-16 min-w-full py-auto  justify-center   bg-teal-600">
                         <h5 class="text-white text-left  align-baseline py-2 leading-tight font-sans font-light text-4xl text-center">SKILLS</h5>
                    </div>
