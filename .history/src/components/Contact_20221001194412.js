               ...
               <div className="flex flex-col gap-4 mt-[8rem] md:flex md:flex-row">
                    ...
                    <div className=" p-4 rounded-lg grid grid-cols-2 items-center px-auto  gap-4 shadow-lg bg-stone-700 max-w-sm h-[1/2] mx-2 md:justify-evenly md:flex md:flex-col md:items-center">
                         <a href="mailTo:shindanosingi1@gmail.com">
                              <div className="bg-[tan] text-[#222]  hover:bg-[tomato] hover:text-[3.5rem]  text-lg text-center font-medium font-sans w-[6.7rem]  md:w-[9rem]  h-12 py-3  px-0.5 rounded-lg">
                                   <EmailIcon/>
                                   Email Me
                              </div>
                         </a>
                         ...
                         <a href={pdf}
                              ...
                              <div className="bg-[tan] text-[#222] w-[6.7rem] hover:bg-[tomato] hover:text-[3.5rem]  text-lg text-center font-medium font-sans md:w-[9rem]  h-12 py-3  px-0.5 rounded-lg">
