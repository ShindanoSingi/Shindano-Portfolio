...
const Contact = () => {
     ...
     return (<div className="grid place  min-h-screen bg-[#050505] pb-4">
               ...
               <form>
                    <div class="form-group mb-6">
                         ...
                         <input type="email" class="form-control
                                                                                                                                ...
                                                                                                                                ease-in-out
                                                                                                                                m-0
                                                                                                                                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                         ...
                         <div class="form-group mb-6">
                              ...
                              <input type="password" class="form-control block
                                                                                                                                                    ...
                                                                                                                                                    ease-in-out
                                                                                                                                                    m-0
                                                                                                                                                    focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInputPassword1" placeholder="Password"></div>
