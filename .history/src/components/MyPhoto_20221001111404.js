          ...
          <div className='grid h-screen font-sans font-light bg-black place-items-center'>
               <div className="flex flex-col items-center bg-black">
                    <img src={avatar}
                         ...
                         alt="Shindano Singi"/>
                    <div className="flex w-[95vw] md:w-[70vw]  flex-col items-center justify-center gap-2 py-2 mx-2 rounded-md lg:w-max-lg md:py-4 bg-slate-600">
