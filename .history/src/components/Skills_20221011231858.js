               ...
               <div className="pb-2 mx-auto md:mt-4">
                    ...
                    <div class="mx-auto mb-2">
                         <div class="block rounded-lg md:mb-2  shadow-lg bg-white w-[90vw] mx-auto  md:max-w-4xl text-center">
                              ...
                              <div class="p-6 grid grid-cols-3 md:grid lg:grid xl:grid md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7  gap-2 items-center  font-sans font-light justify-center">
                                   <div className="flex flex-col items-center">
                                        <img
                                             src={html}
                                             className="w-16"
