          ...
          <div className='grid h-screen font-sans font-light bg-black place-items-center'>
               ...
               <div className="">
                    <img src={avatar}
                         ...
                         alt="Shindano Singi"/>
                    <div className="py-2 mx-2 rounded-md lg:mx-auto lg:w-1/2 md:mx-4 md:py-4 bg-slate-600">
                         ...
                         <h2 className="mx-auto lg:text-4xl lg:mx-auto  text-white text-2xl md:text-4xl  w-[90vw] text-center 2xl:text-4xl ">I want to
