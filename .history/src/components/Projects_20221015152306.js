               ...
               <div className="flex flex-col min-h-full  px-2 font-sans font-light py-2  gap-4 pt-[4rem]  bg-black  min-w-full">
                    <div class="flex justify-center pt-20">
                         ...
                         <div className='flex items-center justify-center gap-4'>
                                   ...
                                   <div className='p-1 text-sm text-center bg-blue-400 border border-black rounded-lg'><a href="https://github.com/ShindanoSingi/BembeChat" target="_blank" rel="noopener noreferrer">GitHub</a> </div>
                              </div>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
                              ...
                              <div className='flex items-center justify-center gap-4'>
                                   <div className='p-1 text-sm text-center bg-blue-400 border border-black rounded-lg'><a href="https://bembe-tube.netlify.app/" target="_blank" rel="noopener noreferrer">Live App</a></div>
                                   <div>
                                   <img class=" w-[22rem] mx-auto h-full md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg"
                                        src={youtube}
                                        alt=""/>
                                   </div>
                                   <div className='p-1 text-sm text-center bg-blue-400 border border-black rounded-lg'><a href="https://github.com/ShindanoSingi/bembe-tube" target="_blank" rel="noopener noreferrer">GitHub</a> </div>
                              </div>
                    ...
                    <div class="flex justify-center mb-4">
                         ...
                         <div className='flex items-center justify-center gap-4'>
                                   ...
                                   <div className='p-1 text-sm text-center bg-blue-400 border border-black rounded-lg'><a href="https://github.com/ShindanoSingi/poor-man-twitter" target="_blank" rel="noopener noreferrer">GitHub</a> </div>
                              </div>
                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col md:text-lg font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
                              <div className='flex items-center justify-center gap-4'>
                                   ...
                                   <div className='p-1 text-sm text-center bg-blue-400 border border-black rounded-lg'><a href="https://github.com/ShindanoSingi/Songs-Library" target="_blank" rel="noopener noreferrer">GitHub</a> </div>
                              </div>
                    ...
                    <div class="flex justify-center mb-4">
                         ...
                         <div className='flex items-center justify-center gap-4'>
                         <div className='p-1 text-sm text-center bg-blue-400 border border-black rounded-lg'><a href="https://bembe-weather.netlify.app/" target="_blank" rel="noopener noreferrer">Live App</a> </div>
                                   <div>
                                   <img class=" w-[22rem] mx-auto  h-full md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg"
                                        src={weather}
                                        alt=""/>
                                   </div>
                                   <div className='p-1 text-sm text-center bg-blue-400 border border-black rounded-lg'><a href="https://github.com/ShindanoSingi/bembe-weather" target="_blank" rel="noopener noreferrer">GitHub</a> </div>
                              </div>
