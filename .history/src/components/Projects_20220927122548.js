          ...
          <div className="">
               <div className="grid h-screen mx-2 place-items-center">
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col md:max-w-2xl rounded-lg bg-white shadow-lg">
                              <img class=" w-max-sm mx-auto  h-full md:h-auto object-cover md:w-max-md rounded-t-lg md:rounded-none md:rounded-l-lg"
                                   src={chatApp}
                                   alt=""/>
