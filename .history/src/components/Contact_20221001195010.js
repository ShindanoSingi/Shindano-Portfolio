                    ...
                    <div class="block p-6 rounded-lg shadow-lg bg-white max-w-sm h-fit mx-2">
                         <div className="flex justify-evenly">
                              <form ref={form}
                                   ...
                                   <SendIcon type="submit" value="Send" class="px-6 py-2.5  text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Send</SendIcon>
                              </form>
                         </div>
                    </div>
