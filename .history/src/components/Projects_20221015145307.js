                    ...
                    <div class="flex justify-center mb-4">
                         <div class="flex flex-col md:text-lg font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
                              <div className='flex items-center justify-center gap-4'>
                                   <div className='px-2 bg-blue-400 rounded-lg'>Live App</div>
                                   <div>
                                        <img class=" w-[22rem] border-black mx-auto  h-full md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg"
                                   src={userM}
                                   alt=""/>
                                   </div>
                                   <div></div>
