          ...
          <div class="flex flex-col font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
            ...
            <div class="p-4 flex flex-col font-sans font-light justify-start w-max-sm">
              ...
              <li class="text-gray-700 md:text-lg font-sans font-light  text-xl mb-4">
                Created an application that enabled users to chat in real time.
                The goal of the project was to let users chat in privacy.
                Implemented user sign- up, sign In; room Creation, Update, and
                Deletion (CRUD). Also, users were able to delete messages. Used
                SQL, relational database to store users’data. The following
                technologies were used: Django and SQL for the back end and
                templates, JavaScript, Vanilla CSS, Materialize, Bootstrap, and
                TailWindCSS were utilized for the front end.
              </li>
              ...
              <p class="text-gray-600 italic text-xl md:text-lg font-sans font-light  text-center">
                Django | SQL | Templates | JavaScript | CSS | Materialize |
          ...
          <div class="flex flex-col font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
            <div class="p-4 flex flex-col md:text-lg justify-start w-max-sm">
              ...
              <li class="text-gray-700 font-sans font-light  text-xl md:text-lg mb-4">
                ...
                React, Vanilla JavaScript, CSS, Materials UI, and Bootstrap on
                the front end, and express, passport, and MongoDB on the
                backend.
              </li>
              <li class="text-gray-700 text-xl md:text-lg font-sans font-light  mb-4">
                Allowed the user to use the app without signing up/in or signing
                up/in. By signing in the user would be able to create playlists,
                like videos... Additionally, we made our app mobile responsive
                so users could be able to use the app on their mobile devices.
              </li>
              <li class="text-gray-700 text-xl font-sans font-light md:text-lg mb-4">
                Collaborated with a team of 4 software engineers in a 2-week
                sprint...
              </li>
              <h6 class="text-gray-900 text-2xl font-sans font-medium text-center mb-4">
                Technologies
          ...
          <div class="flex flex-col md:text-lg font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
            ...
            <div class="p-4 flex flex-col justify-start w-max-sm">
              ...
              <li class="text-gray-700 font-sans font-light text-xl  mb-4">
                Created a single-page full-stack web application (poor man’s
                Twitter) using SQL for the backend, Vue, CSS, TailwindCSS,
                bootstrap, CSS, and Javascript for the front end.
              </li>
              <h6 class="text-gray-900 text-2xl font-sans font-medium text-center mb-4">
                Technologies
              </h6>
        ...
        <div class="flex justify-center mb-4">
          <div class="flex flex-col md:text-lg font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
            ...
            <div class="p-4 flex flex-col justify-start w-max-sm">
              ...
              <li class="text-gray-700 font-sans font-light text-xl md:text-lg  mb-4">
                Made RESTful API fetch calls to an Express, MongoDB, Node.js
                backend
              </li>
              <li class="text-gray-700 font-sans font-light text-xl  md:text-lg  mb-4">
                Created an application that utilized fetch calls to YouTube
                videos API. Implemented a user management system to let the user
                create an account so he/she could be able to sign in and access
                the YouTube app that I customized to play videos without ads.
              </li>
              <li class="text-gray-700 text-xl font-sans font-light  md:text-lg  mb-4">
                Used Vanilla Java Script, handlebars, EJS, CSS, bootstrap, and
                awesome fonts for the front end.
              </li>
              <li class="text-gray-700 font-sans font-light text-xl md:text-lg mb-4">
                Made RESTful API fetch calls to an Express, MongoDB, Node.js
                backend handling all Create, Read, Update and Delete (CRUD)
                operations, and tested all backend routes during development
                using Postman.
              </li>
              <li class="text-gray-700 font-sans font-light text-xl  md:text-lg  mb-4">
                Used Mongoose to define schemas for MongoDB collections, and
                express for the database.
              </li>
              <li class="text-gray-700 font-sans font-light text-xl  md:text-lg  mb-4">
                Implemented ES6 tagged template literals with styled-components
                along CSS3 to provide style and flex-box layout of the
                application.
              </li>
        ...
        <div class="flex justify-center mb-4">
          <div class="flex flex-col font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
            ...
            <div class="p-4 flex flex-col md:text-lg  justify-start w-max-sm">
              ...
              <li class="text-gray-700 font-sans font-light text-xl md:text-lg  mb-4">
                Created a worldwide weather app using weather API. The app
                utilized these technologies: React, CSS, materialize, and
                BootStrap.
              </li>
          ...
          <div class="flex flex-col font-sans font-light p-2 md:py-6 md:max-w-3xl rounded-lg bg-white md:w shadow-lg">
            ...
            <div class="p-4 flex flex-col md:text-lg justify-start w-max-sm">
              ...
              <li class="text-gray-700 font-sans font-light md:text-lg text-xl mb-4">
                ...
                Js, and HTML to generate questions and answers. The app had two
                modes: In the first mode, challenge mode, the user was being
                challenged based on the difficulty level selected. In the second
                mode, the learning mode, the user was learning; that is, the
                user should click on the answer button to see the answer. Used
                CSS to style the application. Reviewed Code prior to running the
                application. Did project documentation in README. Followed test
                procedures to successfully build the application.
              </li>
